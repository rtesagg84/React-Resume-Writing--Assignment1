        ...
        detail: [
            {
                ...
                detail2: '	Wrote code to create new software and customized pre-existing software’s based on the solution architect gathered data using VB.Net and increase the performance of the software development team by 70%.',
                detail3:'	Performed several unit and functional testing processes for user approval for more than 60%.',
                detail4:'	Designed documents and training manual for client use when implementing new systems as a guideline for learning and understanding new system'
            }
        ]
    },
    {
